...
1. Enter the following comment and click the **Submit review** button.
   ...
   <img width="300" alt="Submit review button" src="https://github.com/drewsElearning/skills-review-pull-requests-0429/blob/main/.github/images/submit-review-button.png?raw=true" />
